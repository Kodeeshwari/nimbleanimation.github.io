...
$(document).ready(function() {
	...
	var fnBorder =  function (){
		viewCss.empty();
			 ...
			 loadContainet.load(loadUrl + " #CssBorderRadius", function() {
						...
						previewAreaBox.css({"border-style":"dashed", "border-width":"5px","-webkit-border-radius":"5px","-moz-border-radius":"5px","border-radius":"5px", "border-color" :"#000000" });
						
						$("#viewCssCode ul li:nth-child(even)").addClass("striped");
						borderStyle.change(function(){
							var a = $("#borderStyle").val();
							previewAreaBox.css({"border-style":a});
							$(".boderstyle").text(a);
						});
						...
						$("#BorderWidth").slider({
								...
								slide: function(event, ui) {
									...
									previewAreaBox.css({"border-width": ui.value+"px"});
						...
						$("#BorderRedius").slider({
								...
								slide: function(event, ui) {
									...
									previewAreaBox.css({"-webkit-border-radius":ui.value +'px',"-moz-border-radius":ui.value +'px',"border-radius":ui.value +'px'});
		...
		var fnBorderRadius =  function (){
						...
						loadContainet.load(loadUrl + " #CssRadius", function() {
						...
						$("#BorderRediusTleft").slider({
								...
								step: 1,
								slide: function(event, ui) {
									previewAreaBox.css({"-moz-border-radius-topleft":ui.value +'px',"-webkit-border-top-left-radius":ui.value +'px',"border-top-left-radius":ui.value +'px'});
						...
						$("#BorderRediusTright").slider({
								...
								step: 1,
								slide: function(event, ui) {
									previewAreaBox.css({"-moz-border-radius-topright":ui.value +'px',"-webkit-border-top-right-radius":ui.value +'px',"border-top-right-radius":ui.value +'px'});
						...
						$("#BorderRediusBleft").slider({
								...
								step: 1,
								slide: function(event, ui) {
									previewAreaBox.css({"-moz-border-radius-bottomleft":ui.value +'px',"-webkit-border-bottom-left-radius":ui.value +'px',"border-bottom-left-radius":ui.value +'px'});
						...
						$("#BorderRediusBright").slider({
								...
								step: 1,
								slide: function(event, ui) {
									previewAreaBox.css({"-moz-border-radius-bottomright":ui.value +'px',"-webkit-border-bottom-right-radius":ui.value +'px',"border-bottom-right-radius":ui.value +'px'});
		...
		var fnBackground =  function (){
			 ...
			 loadContainet.load(loadUrl + " #CssBackground", function() {
						...
						previewAreaBox = $(".previewAreaBox");
						previewAreaBox.css({"background-color":"#FF8C3C","background-image":"url(http://www.css3maker.com/reference/font/image.png)","background-position":"left top","background-repeat":"no-repeat" });
						...
						editThis.keyup(function(){
							...
							var c = "#"+input3.val();
							var b = input2.val()+"px";
							previewAreaBox.css({"border-width":a ,"border-color":c  ,"-webkit-border-radius":b,"-moz-border-radius":b,"border-radius":b });
							$(".input1").text(a);
							$(".input3").text(c);
							$(".input2").text(b);
						});
		...
		var fnBoxShadow = function (){
					...
					browserComptability.text("Box Shadow");
				 	...
				 	loadContainet.load(loadUrl + " #BoxShadow", function() {
						AllShow.removeClass("inactive");
						browserMozilla.text("3.5+");
						browserIe.text("9+");
						browserSafari.text("3.0+");
						...
						previewAreaBox = $(".previewAreaBox");
						previewAreaBox.css({"-moz-box-shadow":"10px 10px 5px #000000", "-webkit-box-shadow":"10px 10px 5px #000000", "box-shadow":"10px 10px 5px #000000"});
									...
									$('#TextShadowColor').ColorPicker({
												...
												onChange: function (hsb, hex, rgb) {
													...
													$('#TextShadowColor div').css('backgroundColor', '#' + hex);
														...
														var e = inset+a+b+c+d;
														previewAreaBox.css({"-moz-box-shadow": e, "-webkit-box-shadow": e, "box-shadow": e});
	...
	var fnTextShadow = function (){
					...
					browserComptability.text("Text Shadow");
				 		...
				 		loadContainet.load(loadUrl + " #textShadow", function() {
						...
						previewAreaBox = $(".previewAreaBox");
						previewAreaBox.css({"text-shadow":"5px 5px 5px #000000" });
						$("#viewCssCode ul li:nth-child(even)").addClass("striped");
							var cssColor = new Array();
							cssColor["valoy"] = "#000000";
							$('#TextShadowColor div').css('backgroundColor', cssColor["valoy"]);
									$('#TextShadowColor').ColorPicker({
												...
												onChange: function (hsb, hex, rgb) {
													$('#TextShadowColor div').css('backgroundColor', '#' + hex);
														...
														previewAreaBox.css({"text-shadow": d});
														$(".text-shadow1").text(a);
														$(".text-shadow2").text(b);
														$(".text-shadow3").text(c);
														$(".text-shadow4").text(e);
	...
	var fnrgba = function(){
					...
					browserComptability.text("RGBA");
				 		loadContainet.load(loadUrl + "  #rgba", function() {
						...
						previewAreaBox = $(".previewAreaBox");
						previewAreaBox.css({"background":"rgba(215, 40, 40, 0.9)" });
	...
	var fnBorderimage = function(){
					...
					loadContainet.load(loadUrl + " #Borderimage", function() {
					viewCss.append("<ul><li>background-image: rgba(<span class='rgba1'>200,</span> <span class='rgba2'> 100,</span> <span class='rgba3'>100,</span> <span class='rgba4'>0.1</span>);</li><li>background: rgba(<span class='rgba1'>200,</span> <span class='rgba2'> 100,</span> <span class='rgba3'>100,</span> <span class='rgba4'>0.1</span>);</li><li>color: rgba(<span class='rgba1'>200,</span> <span class='rgba2'> 100,</span> <span class='rgba3'>100,</span> <span class='rgba4'>0.1</span>);</li></ul>");
						...
						previewAreaBox = $(".previewAreaBox");
						previewAreaBox.css({"background-color":"rgba(200, 100, 100, 0.1)" });
		...
		var fntextRotation = function(){
					...
					loadContainet.load(loadUrl + " #textRotation", function() {
					viewCss.append("<ul><li>-webkit-transform:  rotate(<span class='textRotation1'>90deg</span>);</li><li>-moz-transform:  rotate(<span class='textRotation1'>90deg</span>);</li><li>-o-transform:  rotate(<span class='textRotation1'>90deg</span>);</li><li>writing-mode: <span class='textRotationForIe'>tb-rl</span>;</li></ul>");
						...
						previewAreaBox.css({"writing-mode":"tb-rl", "-webkit-transform":"rotate(90deg)", "-moz-transform":"rotate(90deg)", "-o-transform":"rotate(90deg)" });
						...
						$("#viewCssCode ul li:nth-child(even)").addClass("striped");
							...
							$("#Rotate").slider({
									...
									slide: function(event, ui) {
										...
										previewAreaBox.css({"writing-mode": c, "-webkit-transform": b, "-moz-transform": b,  "-o-transform": b });
		...
		var fncssTransform = function(){
					...
					loadContainet.load(loadUrl + " #CSStransform", function() {
					viewCss.append("<ul><li>transform:  <span class='transformCord'>rotate(90deg) scale(1) skew(1deg) translate(10px)</span>;</li><li>-webkit-transform:  <span class='transformCord'>rotate(90deg) scale(1) skew(1deg) translate(10px)</span>;</li><li>-moz-transform: <span class='transformCord'>rotate(90deg) scale(1) skew(1deg) translate(10px)</span>;</li><li>-o-transform:  <span class='transformCord'>rotate(90deg) scale(1) skew(1deg) translate(10px)</span>;</li><li>-ms-transform:  <span class='transformCord'>rotate(90deg) scale(1) skew(1deg) translate(10px)</span>;</li></ul>");
						...
						previewAreaBox = $(".previewAreaBoxRotet");
						PreviewArea.css({"transform":"rotate(4deg)", "-webkit-transform":"rotate(4deg)", "-moz-transform":"rotate(4deg)", "-o-transform":"rotate(4deg)",  "-ms-transform":"rotate(4deg)" });
						
						$("#viewCssCode ul li:nth-child(even)").addClass("striped");
						
						
							
							$(".transformSelect").live('click',function(){
							...
							$("#Rotate").slider({
									...
									slide: function(event, ui) {
										...
										if(transformactive=='Rotate'){
											...
											PreviewArea.css({"transform": b, "-webkit-transform": b, "-moz-transform": b,  "-o-transform": b, "-ms-transform": b  });
										$(".transformCord").text(b);
											
										}else if(transformactive == 'All'){
											PreviewArea.css({"transform": f, "-webkit-transform": f, "-moz-transform": f,  "-o-transform": f, "-ms-transform": f  });
							...
							$("#Scale").slider({
									...
									slide: function(event, ui) {
										...
										if(transformactive=='Scale'){
											...
											PreviewArea.css({"transform": g, "-ms-transform": g, "-webkit-transform": g, "-moz-transform": g,  "-o-transform": g });
										$(".transformCord").text(g);
											
										}else if(transformactive == 'All'){
											PreviewArea.css({"transform": f, "-ms-transform": f, "-webkit-transform": f, "-moz-transform": f,  "-o-transform": f });
											$(".transformCord").text(f);
										}
							...
							$("#Translate").slider({
									...
									slide: function(event, ui) {
										...
										$(".transformCord").text(g);
											...
											PreviewArea.css({"transform": g, "-ms-transform": g, "-webkit-transform": f, "-moz-transform": f,  "-o-transform": f });
											$(".transformCord").text(f);
										}
	...
	var fnFontFace = function(){
					...
					loadContainet.load(loadUrl + " #FontFace", function() {
					viewCss.append("<ul><li>@font-face { font-family: '<span class='SelectFont'>BrushScriptStdMedium</span>';</li><li>src: url('<span class='fontsrc'>brushscriptstd</span>.eot');</li><li>src: local('<span class='fontlocal'>Brush Script Std</span>'), local('<span class='fontlocal2'>BrushScriptStd</span>'), url('<span class='fontsrc'>brushscriptstd</span>.woff') format('woff'), url('<span class='fontsrc'>brushscriptstd</span>.ttf') format('truetype');}</li><li>.classname{ font:<span class='fontsize'>21px</span> <span class='fontWeight'>bold</span> <span class='fontStyle'>italic</span>  <span class='SelectFont'>Arial</span>;}</li></ul>");
						...
						previewAreaBox = $(".previewAreaBox");
						previewAreaBox.css({"font-family":"BrushScriptStdMedium", "font-size":"21px", "font-style":"normal", "font-weight":"bold"  });
						...
						$("#viewCssCode ul li:nth-child(even)").addClass("striped");
							...
							$("#FontSize").slider({
								...
								previewAreaBox.css({"font-family": a, "font-size": b, "font-style": c, "font-weight":d  });
								$(".SelectFont").text(a);
								$(".fontsize").text(b);
								$(".fontStyle").text(c);
								$(".fontWeight").text(d);
		...
		var fnOutline = function(){
					...
					loadContainet.load(loadUrl + " #CssOutline", function() {
					viewCss.append("<ul><li>outline-style:<span class='outlinestyle'>dashed</span>;</li><li>outline-width:<span class='outlinewidth'>5px</span>;</li><li>outline-color: <span class='outlinecolor'>#000000</span>;</li> <li>outline-offset: <span class='outlineoffset'>5px</span>;</li></ul>");
						...
						previewAreaBox = $(".previewAreaBox");
						previewAreaBox.css({"outline-style":"dashed", "outline-width":"5px", "outline-color":"#000000", "outline-offset":"5px" });
						...
						$("#viewCssCode ul li:nth-child(even)").addClass("striped");
							...
							$("#BorderWidth").slider({
								...
								slide: function(event, ui) {
									...
									previewAreaBox.css({"outline-width": ui.value+"px"});
							...
							$("#Outline-offset").slider({
								...
								slide: function(event, ui) {
									...
									previewAreaBox.css({"outline-offset": ui.value+"px"});
							...
							$(".editThis").keyup(function(){
								...
								previewAreaBox.css({"outline-style": c, "outline-width": a, "outline-color": d, "outline-offset": e});
							...
							$(".editThis").change(function(){
								...
								previewAreaBox.css({"outline-style": c});
		...
		var fnGradient =  function (){
			...
			if ($.browser.webkit) {
						...
						loadContainet.load(loadUrl + " "+lodinforamtion, function() {
						...
						previewAreaBox = $(".previewAreaBox");
						previewAreaBox.css({"background":"-webkit-gradient(linear, 100% 0, 100% 100%, from(#ccc), to(#000))"});
						...
						CssGradientinfo.each(function() {
									...
									$(this).empty().slider({
										...
										slide: function(event, ui) {
											...
											var Type = $("#type").val();
											if(Type == "linear"){
											previewAreaBox.css({"background":"-webkit-gradient("+Type+", "+hPosition+"% "+ getPosition+"%, "+endhPosition+"% "+getendvPosition+"%, from(#"+ColorStart+"), to(#"+ColorEnd+"))"});
											 $(".css-Gradient").text("-webkit-gradient("+Type+", "+hPosition+"% "+ getPosition+"%, "+endhPosition+"% "+getendvPosition+"%, from(#"+ColorStart+"), to(#"+ColorEnd+"))");
											 };
											 if(Type == "radial"){
											previewAreaBox.css({"background":"-webkit-gradient(radial, "+hPosition +" " + getPosition+", "+startvRadial+", "+endhPosition+"  "+getendvPosition+", "+endRadial+",  from(#"+ColorStart+"), to(#"+ColorEnd+"))"});
				...
				lodinforamtion = " #moz"+information;
						...
						PreviewArea.append("<div class='previewAreaBox'> Css Gradient </div>");
						previewAreaBox = $(".previewAreaBox");
						previewAreaBox.css({"background":"-moz-linear-gradient(100% 0 100deg, #ccc, #000)"});
						...
						CssGradientinfo.each(function() {
									...
									$(this).empty().slider({
										...
										slide: function(event, ui) {
											...
											var Type = $("#type").val();
											if(Type == "linear"){
											previewAreaBox.css({"background":"-moz-linear-gradient("+hPosition+"% "+ getPosition+"% "+startvRadial+"deg, #"+ColorStart+", #"+ColorEnd+ " "+endhPosition+"%)"});
											 $(".css-Gradient").text("-moz-linear-gradient("+hPosition+"% "+ getPosition+"% "+startvRadial+"deg, #"+ColorStart+", #"+ColorEnd+" "+endhPosition+"%)");
											 };
											 if(Type == "radial"){
											previewAreaBox.css({"background":"-moz-radial-gradient("+hPosition+"% "+ getPosition+"% "+startvRadial+"deg, #"+ColorStart+", #"+ColorEnd+ " "+endhPosition+"%)"});
		...
		var fncssAnimation = function(){
					...
					loadContainet.load(loadUrl + " #CSSAnimation", function() {
					viewCss.append("<ul><li>.classname {</li><li>-webkit-animation: cssAnimation <span class='duration'>1s</span>  <span class='Iteration'>16</span> <span class='animation-timing'>ease</span>;</li><li>-moz-animation: cssAnimation <span class='duration'>1s</span>  <span class='Iteration'>16</span> <span class='animation-timing'>ease</span>;</li><li>-o-animation: cssAnimation <span class='duration'>1s</span>  <span class='Iteration'>16</span> <span class='animation-timing'>ease</span>;</li><li>}</li><li> @-webkit-keyframes cssAnimation {</li><li>from { -webkit-transform:  <span class='transformCord'>rotate(4deg) scale(1) skew(1deg) translate(10px)</span>; } </li><li> to { -webkit-transform:  <span class='transformEnd'>rotate(4deg) scale(1) skew(1deg) translate(10px)</span>; }</li><li> }</li><li> @-moz-keyframes cssAnimation {</li><li>from { -moz-transform:  <span class='transformCord'>rotate(4deg) scale(1) skew(1deg) translate(10px)</span>; } </li><li> to { -moz-transform:  <span class='transformEnd'>rotate(4deg) scale(1) skew(1deg) translate(10px)</span>; }</li><li> }</li><li> @-o-keyframes cssAnimation {</li><li>from { -o-transform:  <span class='transformCord'>rotate(4deg) scale(1) skew(1deg) translate(10px)</span>; } </li><li> to { -o-transform:  <span class='transformEnd'>rotate(4deg) scale(1) skew(1deg) translate(10px)</span>; }</li><li> }</li></ul>");
						...
						PreviewArea.append("<div class='previewAreaBox'> Element<span class='start'>-webkit-transform: rotate(4deg) scale(1) skew(1deg) translate(10px); -moz-transform: rotate(4deg) scale(1) skew(1deg) translate(10px); -o-transform: rotate(4deg) scale(1) skew(1deg) translate(10px)</span><span class='end'></span></div>");
						previewAreaBox = $(".previewAreaBoxRotet");
						PreviewArea.css({"-webkit-transform":"rotate(4deg)", "-moz-transform":"rotate(4deg)", "-o-transform":"rotate(4deg)" });
							...
							$("#Rotate").slider({
									...
									slide: function(event, ui) {
										...
										if(transformactive=='End'){
											...
											PreviewArea.css({"-webkit-transform": f, "-moz-transform": f,  "-o-transform": f });
											$(".transformEnd").text(f);
...
setTimeout(function(){ 
   var banner =  $('.banner');
		 ...
		 banner.animate({"height": "+=40px"}, "slow");
...
$(function(){
	...
	$(".narrowcolumnRight").find("h2:first").append("<a href='#' id='download'></a>");
